...
#Write-host '=========='
        ...
        Write-Host "Internet config confirmation"  -BackgroundColor darkgray
                ...
                netsh routing ip nat show interface Internet
                $code=$code + (IIf $? $flag 0)
        ...
        Write-Host "WAN config confirmation"  -BackgroundColor darkgray
                ...
                foreach($lan in $alllan) {
                    if ($lan -eq $LANgatewayIP) {
                        Find-NetRoute -RemoteIPAddress $lan | Where {$_.InterfaceAlias -eq "LAN"}
                        $code=$code + (IIf $? $flag 0)
                        ...
                        Find-NetRoute -RemoteIPAddress $lan | Where {$_.InterfaceAlias -eq "WAN"}
                        $code=$code + (IIf $? $flag 0)
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJU0O7M+tF2NnaI8wl4jdZzYC
# tYOgghYZMIIDDjCCAfagAwIBAgIQILC/BxlyRYZJ/JpoWdQ86TANBgkqhkiG9w0B
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSE2+KsgJNEHYlXlFOYCa4b
# rSDRWTANBgkqhkiG9w0BAQEFAASCAQBQKyAkOvqErtXChS5yKOhg67yaLeWfN+8g
# de3NBvmA1QpQYU1/jFGz2GEqb4h8tSTnAqDboxNegmm9OMUgt5Ne4ghtC3B/uGyI
# nphpzqbw7Pxaohn67iYPWuh7/O2Tjx/vZHbkxWULI31hYIXra/nEW14Q3LodXl8M
# 3l2pn+Ilec+7GZS61X0W2MpnCnVEWf+vbvWJtw/fTSQmQ1wpQFrS3NQ6wyEgnDcY
# tTmErRxOjTInOyXZhO9ag6kp1iS/nfs3rEX0Onsp8Vv37nbCxJhKDPdkzSGvXNpn
# FyvtulXjujYd6GEC5tI8oGwru+Z75pZMlRA5XotZhBa3ouy3zE4DoYIDIDCCAxwG
...
# hvcNAQkFMQ8XDTIzMDcwNDIzMDIwOVowLwYJKoZIhvcNAQkEMSIEIC540OpMSsSP
# YvADsZXjysoAWobnq33M+2WivcbYCbRgMA0GCSqGSIb3DQEBAQUABIICADxgR89h
# YNDreZDNmLrywuAO3DtSYv4xOKzo/JIHJEwKxWhttJ5SAdpGEBeLjR3FHEBAmsO2
# rQAPhtJwILUWYqjmDLqo6nL41ho+guwDxzSaUia8a3f7fFhp7gMAVKJVxL7bh4T7
# UdzZtuFQI4nFLpy6F9hATEK48k9GCZGE4GWfCQrZl75I5KXikGJhPcZBMzjDjkTl
# kWEaxLKRuqh0VqdIuxtWLYGBZ4jYY7lnd2MF65ev7OAXhjvThu4kpA3DbA1O7G4l
# L3AemcSw8iOIL2thS2Y3qHAH2nTjpgykhTGbNKPlAdwPgfug6GEw563dBeSGpWlB
# E/aV9xy7fay+VYdgOposYU4qm9vARwm+sYKruONTKpLGHNmuDPnpaOgkcxM73UPq
# jb+NmnaeKfR9BQD9HsfQi228JqJCjD/AL+XzUE5HOuJ4EFvG8UbgKAqw6YcfHnQT
# acdzXnrTimPK1Jj+px85SZQNbGXQZzKQmrAWjGX8YLAGlHMdAaFUsB2Y6z0UazrQ
# oeVvoWyFc9wjQsuiTYxOTbQtVl+fRjEuzuQAovFWUwe+T2FBhhOuqdNVDrRQOBSm
# Ti6QorPlr/qg2HXiZAt/F1sLkb4uWiKkRCx6DHsMAcYR8Ym7qcUD8s6tlvDeAOhh
# ItYiqY3Hko63GVGzhnLqM3kLE7MyK1B8+xqa
